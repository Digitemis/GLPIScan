...
CVE = [
       ...
       ['GLPI', [['>=', '0.68'], ['<=', '9.4.5']], 'Reflected XSS in Dropdown endpoints' ,'https://offsec.almond.consulting/multiple-vulnerabilities-in-glpi.html', 'CVE-2020-11062'],
       ...
       ['GLPI', [['<', '9.5.2']], 'Unauthenticated File Deletion' ,'https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2020-15175', 'CVE-2020-15175'],
       ['GLPI', [['<', '9.5.2']], 'User information leakage in Public FAQ' ,'https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2020-15217', 'CVE-2020-15217'],
       ['GLPI', [['<', '9.5.2']], 'Cross Site Scripting (XSS) in install/install.php' ,'https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2020-15177', 'CVE-2020-15177'],
       ['GLPI', [['<', '9.5.2']], 'SQL Injection in the APIs search function' ,'https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2020-15226', 'CVE-2020-15226'],
       ]
